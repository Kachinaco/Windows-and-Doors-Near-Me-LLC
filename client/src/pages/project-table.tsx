                            ...
                            {(item.folders || []).map((folder) => (
                              <React.Fragment key={folder.id}>
                                ...
                                <div className="flex hover:bg-blue-50 bg-blue-25 border-b border-blue-200 group">
                                  ...
                                  {/* Sub-item Column Headers with 3-dot menus - Remove SUB ITEMS column */}
                                  <div
                                      ...
                                      >
                                        <div className="flex items-center justify-between">
                                          <input
                                            ...
                                            className="text-xs border-none bg-transparent text-blue-700 outline-none"
                                          />
                                          <button
                                            onClick={() =>
                                              setColumnMenuOpen(
                                                columnMenuOpen ===
                                                  `subitem-${subItem.id}-date`
                                                  ? null
                                                  : `subitem-${subItem.id}-date`,
                                              )
                                            }
